package com.longyg.backend.ars.tpl.definition.counters;
...
public class CountersTplDefParser {
    public CountersTplDef parse(String templatePath) throws FileNotFoundException, XMLStreamException {
        XMLInputFactory factory = XMLInputFactory.newInstance();
        XMLEventReader eventReader = factory.createXMLEventReader(new FileReader(templatePath));

        CountersTplDef tplDef = new CountersTplDef();
